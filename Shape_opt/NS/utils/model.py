...
class NN(torch.nn.Module):
    ...
    def forward(self,x,y):
        ...
        x3 = torch.tanh(self.L3(x2)) + x1
        x3 = self.L4(x2)

        return x3

class pres(torch.nn.Module):
    def __init__(self):
...
class NN_hpinn(torch.nn.Module):
    def __init__(self):
        super(NN_hpinn,self).__init__()
        self.L1 = torch.nn.Linear(2,30)
        self.L2 = torch.nn.Linear(30,30) 
        self.L3 = torch.nn.Linear(30,30)
        self.L4 = torch.nn.Linear(30,30)
    ...
    def forward(self,x,y):
        ...
        out = (r2-1.0)*(r2-9.0)*x3 + r2 #since the groundtruth for y is r^2
